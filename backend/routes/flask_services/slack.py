...
slack_blueprint = Blueprint('slack_blueprint', __name__, template_folder='../templates')
...
def slack():
    ...
    return render_template('slack.html', channels=channels)

@slack_blueprint.route('/slack/invite_user', methods = ['POST'])
def invite_user():
    data = {
